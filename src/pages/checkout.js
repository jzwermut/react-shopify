 ...
 window.location.href = `${cart.webUrl}`
  ...
  <div>
    ...
    <div className="container mx-auto p-20">
      <div className="text-center font-large mb-10"> Shipping deets</div>
    
      <form onSubmit={handleSubmit}>
        <div className="mb-6">
          <label for="addressLine1" className="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">Address line 1</label>
        ...
        <div className="mb-6">
          <label for="addressLine1" className="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">Address line 2</label>
        ...
        <div className="mb-6">
          <label for="addressLine1" className="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">City</label>
        ...
        <div className="mb-6">
          <label for="addressLine1" className="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">Country</label>
        ...
        <div className="mb-6">
          <label for="addressLine1" className="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">First Name</label>
        ...
        <div className="mb-6">
          <label for="addressLine1" className="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">Last Name</label>
        ...
        <div className="mb-6">
          <label for="addressLine1" className="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">Phone</label>
        ...
        <div className="mb-6">
          <label for="addressLine1" className="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">State</label>
        ...
        <div className="mb-6">
          <label for="addressLine1" className="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">Postcode</label>
